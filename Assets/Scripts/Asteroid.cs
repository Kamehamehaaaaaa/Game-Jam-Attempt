...
public class Asteroid : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        flameAnimator = transform.GetChild(0).gameObject;
    }
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        if (collision.gameObject.CompareTag("Bullet"))
        {
            ...
            Destroy(flameAnimator.gameObject);
    ...
    private Asteroid CreateSplit()
    {
        ...
        Asteroid half = Instantiate(this, position, transform.rotation, transform.parent);
        half.size = size * 0.5f;
